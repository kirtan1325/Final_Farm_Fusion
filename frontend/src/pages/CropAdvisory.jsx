      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        ...
        <header className="ff-topbar">
          ...
          <div className="flex items-center gap-3 flex-1">
            ...
            <div>
              <h1 className="font-bold text-gray-900 leading-tight">Crop Advisory</h1>
              <p className="text-xs text-gray-500 hidden sm:block">Expert growing tips & best practices</p>
            </div>
          </div>
          {user && (
