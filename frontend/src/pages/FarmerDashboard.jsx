...
function AddCropModal({ onClose, onSave }) {
  ...
  return (
    <div className="ff-modal-overlay">
      <div className="ff-modal ff-scale-in">
        {/* Modal Header */}
        ...
        <div className="px-6 py-4 border-t border-gray-100 flex gap-3">
          <button onClick={onClose} className="ff-btn ff-btn-secondary flex-1">Cancel</button>
    ...
    <div className="flex h-screen bg-gray-50 font-sans overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        ...
        <header className="ff-topbar flex-shrink-0 sticky top-0 z-20">
          ...
          <button onClick={() => setShowModal(true)} className="ff-btn ff-btn-primary flex-shrink-0">
            <PlusIcon />
                ...
                <div key={crop._id} className="flex items-start gap-3 px-4 py-4 hover:bg-gray-50 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <button onClick={() => handleDelete(crop._id)}
                        className="text-gray-400 hover:text-red-500 mt-0.5 flex-shrink-0 cursor-pointer text-xs font-semibold transition-colors hover:bg-red-50 px-2 py-1 rounded-lg">
                        Delete
                      </button>
                    </div>
